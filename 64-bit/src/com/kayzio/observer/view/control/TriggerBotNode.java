...
public class TriggerBotNode extends HBox implements Observer{
	...
	private BooleanProperty isNodeDisabledProperty = new SimpleBooleanProperty(false);

	// MAIN CONTROLS / NODES
	private Label titleLabel;
	private Label statusLabel;

	public TriggerBotNode(int windowWidth, int windowHeight, int edgeMargin, int keyCode){
		this.windowWidth = windowWidth;
		this.windowHeight = windowHeight;
		this.edgeMargin = edgeMargin;
		disableKey = keyCode;
		
		titleLabel = new Label("Trigger Bot - ");
		statusLabel = new Label(ENABLE);
